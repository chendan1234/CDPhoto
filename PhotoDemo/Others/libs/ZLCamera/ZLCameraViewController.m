...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CDPhotoPickerBrowserViewController *browserVc = [[CDPhotoPickerBrowserViewController alloc] init];
    browserVc.dataSource = self;
    browserVc.delegate = self;
    browserVc.showType = CDShowImageTypeImageBroswer;
...
- (void)displayImage:(UIImage *)images {
    CDCameraImageView *view = [[CDCameraImageView alloc] initWithFrame:self.view.frame];
    view.delegate = self;
