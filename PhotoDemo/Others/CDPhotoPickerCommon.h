...
//图片显示器分类
typedef NS_ENUM(NSInteger, CDShowImageType) {
    CDShowImageTypeImagePicker = 0, //照片选择器
    CDShowImageTypeImageBroswer,    //照片浏览器
    CDShowImageTypeImageURL,        //网络图片浏览器
};
...
// ScrollView 滑动的间距
static CGFloat const CDPickerColletionViewPadding = 20;

// 进度条的宽度/高度
static NSInteger const CDPickerProgressViewW = 50;
static NSInteger const CDPickerProgressViewH = 50;

// 分页控制器的高度
static NSInteger const CDPickerPageCtrlH = 25;
